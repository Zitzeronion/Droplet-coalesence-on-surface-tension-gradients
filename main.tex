...
\begin{equation}\label{eq:LBE}
    ...
    \end{split}
\end{equation}
with $F$ being the total force acting on the fluid.
...
\end{equation}
Inserting the simulation parameters, see the App.~\ref{app:one}, we get $\tau_{\text{ic.}} \approx 7\cdot 10^5 \Delta t$. 
In Fig.~\ref{fig:final_state} we display the time evolution of three different surface tension fields.
